...
export default {
  ...
  'auth/no-valid-user': 'Please try to log in again',
  ...
  // Offline
  clientOffline: 'You are currently offline.',
  reconnectMessage: 'Reconnect to the internet and try again.',
  retry: 'Retry',
  ...
  genericLoginErrorMessage: 'Login failed, please try again later.',
